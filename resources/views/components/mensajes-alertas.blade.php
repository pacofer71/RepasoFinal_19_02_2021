...
<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-6" role="alert" mb-6>
    <strong class="font-bold">Mensaje Error</strong>
...
<div class="bg-green-200 border border-green-400 text-red-700 px-4 py-3 rounded relative mb-6" role="alert">
